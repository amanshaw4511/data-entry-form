...
const AddVaccinationCentre = ({ cities }) => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <Text_input register={register} name="price" type="number" />

      <Text_input register={register} name="ageGroup" />

      <Text_input register={register} name="date" type="date" />

      {inputTiming({}, register)}

      <Check_box register={register} name="isAvailable" />
